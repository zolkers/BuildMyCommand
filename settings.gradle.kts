...
project(":adapters:discord").projectDir = file("modules/adapters/discord")
...
project(":adapters:terminal").projectDir = file("modules/adapters/terminal")
